...
class AdminUsersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('Admin Users Screen (Coming Soon)'),
      ),
    );
  }
}
...
class AdminReviewsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('Admin Reviews Screen (Coming Soon)'),
      ),
    );
  }
}
...
class AdminCommunityPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Admin - Community')),
      body: const Center(
        child: Text('Admin Community Screen (Coming Soon)'),
      ),
    );
  }
}
