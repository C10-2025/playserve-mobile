          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Payment & Confirmation', style: BookingTextStyles.title),
                ...
                if (errorMsg != null)
                  Padding(
                    ...
                    child: Text(errorMsg!, style: const TextStyle(color: BookingColors.red600)),
                  ),
  ...
  Widget _summaryCard(int approxTotal) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Booking Summary', style: BookingTextStyles.title.copyWith(fontSize: 18)),
  ...
  Widget _qrisBlock() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Payment Instructions', style: BookingTextStyles.title.copyWith(fontSize: 18)),
          const SizedBox(height: 10),
          Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                Icon(Icons.qr_code_2, size: 64, color: BookingColors.gray500),
                SizedBox(height: 8),
                Text('QRIS placeholder'),
              ],
            ),
          ),
        ],
  ...
  Widget _uploadBlock() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Upload Payment Proof', style: BookingTextStyles.title.copyWith(fontSize: 18)),
          const SizedBox(height: 10),
          OutlinedButton.icon(
            icon: const Icon(Icons.upload_file),
            label: Text(proof == null ? 'Upload (optional)' : 'Change file'),
            style: BookingDecorations.secondaryButton,
            onPressed: () async {
          ...
          if (proof != null) ...[
            ...
            Text('Selected: ${proof!.path.split('/').last}',
                style: BookingTextStyles.cardSubtitle),
          ],
        ],
      ),
        ...
        try {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context)
                .showSnackBar(SnackBar(content: Text('Proof upload failed: ${e.message}')));
          }
        } catch (e) {
          if (mounted) {
            ScaffoldMessenger.of(context)
