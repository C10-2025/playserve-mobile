              ...
              child: Column(
                ...
                children: [
                  ...
                  if (field.amenities != null && field.amenities!.isNotEmpty)
                    _amenities(),
                  if ((field.ownerContact != null &&
                          field.ownerContact!.isNotEmpty) ||
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                BookingStep1IdentityScreen(draft: draft),
                          ),
                        );
                      },
      ...
      child: Column(
        ...
        children: [
          ...
          if (field.ownerContact != null && field.ownerContact!.isNotEmpty) ...[
            ...
            Text(
              'Contact the court at ${field.ownerContact}',
