...
class _CommunityDetailPageState extends State<CommunityDetailPage> {
  ...
  Future<void> _loadCommunity() async {
    ...
    // kalau backend balikin error JSON
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 🔵 Background image, sama seperti discover & my communities
          Positioned.fill(
            child: Image.asset(
          ...
          // 🔲 SafeArea + HEADER + isi page
          SafeArea(
            child: Column(
              children: [
                // ⬇️ PROFILE HEADER DI ATAS
                const Padding(
                ...
                // Sisanya isi lama dibungkus di Expanded + FutureBuilder
                Expanded(
                  child: FutureBuilder<void>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // === UI normal kalau data sudah ke-load ===
                      return Padding(
                          ...
                          child: ConstrainedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // ========== START NEW DISCUSSION CARD (compact) ==========
                                Container(
                                  padding: const EdgeInsets.symmetric(
                                ...
                                // ========== BAGIAN YANG SCROLL HANYA POSTNYA ==========
                                Expanded(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            reply.createdAt.toLocal().toString().substring(0, 16),
                                                                            style:
                                                                                GoogleFonts.inter(
